 ...
 * @author rlaecio
 */
public class ConsultaTitulacao extends javax.swing.JDialog {
    public int grauId;
    public String grauNome;

    public ConsultaTitulacao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        try {
            ...
            Logger.getLogger(ConsultaTitulacao.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Selecione uma Titulação da Lista");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(28, 28, 28)
                .addComponent(tfGrauNome, javax.swing.GroupLayout.PREFERRED_SIZE, 487, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTable1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ConsultaTitulacao.this.mouseClicked(evt);
            }
        });
    ...
    private void mouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mouseClicked
         if (evt.getClickCount() == 2) {                           
            tfGrauNome.setText(jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString());             
    ...
    private void aoClicarConsulta(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aoClicarConsulta
         grauNome = tfGrauNome.getText();
        if (!(grauNome==null || grauNome.equals(""))) {
            try {
                GrauDAO dao = new GrauDAO();                                                                     
                GrauBeans aut1 = dao.procurarGrau(grauNome);                                                   
                tfGrauNome.setText(String.valueOf(aut1.getGrauNome()));                                           
                filtraTabela(grauNome);
            } catch (Exception e) {                       
            }
        }    
    ...
    private void buscaDaLista(String nome) {       
        if (!(nome==null || nome.equals(""))) {
            try {
                GrauDAO dao = new GrauDAO();                                                                     
                GrauBeans aut1 = dao.procurarGrau(nome);                                            
                grauId = aut1.getGrauId();   
                grauNome = aut1.getGrauNome();
                this.dispose();                
            } catch (Exception e) {                       
            }
        }        
    ...
    private void preencherGrau() throws Exception {                 
            DefaultTableModel modelo = (DefaultTableModel)jTable1.getModel();   
            modelo.setNumRows(0);   
            GrauDAO dao = new GrauDAO();
            ArrayList<GrauBeans> listar = dao.todasGraus();            
            for (GrauBeans grau : listar) {
               modelo.addRow(new Object[] { grau.getGrauNome()});    
            }
    }
    ...
    private void filtraTabela(String nome) throws Exception {                 
            ...
            for (GrauBeans autor : listar) {
               modelo.addRow(new Object[] { autor.getGrauNome()} );    
            }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ConsultaTitulacao dialog = new ConsultaTitulacao(new javax.swing.JFrame(), true);
